...
# print classification accuracy by FORMULA
classification_accuracy = (TP + TN) / float(TP + TN + FP + FN)*100
print('Classification accuracy : {0:0.4f}'.format(classification_accuracy))

# Print the accuracy by coding
...
print('f1_score of macro :',f1_score(y_test, logreg_y_pred))

print('Classification Report: \n', classification_report(y_test,logreg_y_pred))
from sklearn.metrics import roc_auc_score
log_auc = round(roc_auc_score(y_test,logreg_y_pred)*100,2)
...
# create plot
plt.plot(FPR,TPR, label='ROC curve of logistic regression')
